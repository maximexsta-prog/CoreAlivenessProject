...
window.CA = (function () {
  ...
  // Le faux magasin ne sert QUE en local. Auparavant « ?mock=1 » suffisait,
  // depuis n'importe ou : n'importe qui pouvait ouvrir /admin?mock=1, taper
  // « demo » et lire les tuiles, donc les adresses des tableaux de bord que
  // le mot de passe est cense proteger. En production, seule l'API decide.
