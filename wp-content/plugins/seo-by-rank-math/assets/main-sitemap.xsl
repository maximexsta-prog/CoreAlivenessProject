			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - The Core Aliveness Project</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - The Core Aliveness Project</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://corealivenessproject.com/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
