...
- [ ] **Stripe** in **Live** mode, deposit link = 1 240 CAD (early payment discount; bump to 1 400 after Oct 26, 2026), **success URL = `/reservation-dws/?paid=1`**, receipts ON
...
- [ ] **Fit** → send the acceptance + deposit email (`email-templates.md` #1), set the **48 h hold**. Offer the **fondateur 3 720** rate to the waitlist / first ~4.
...
- [ ] Confirm your **3 995** price is built on the local operator's **VAT-inclusive** (20 %) quote
